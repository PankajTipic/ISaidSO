...
export function PredictionCard({ prediction }: PredictionCardProps) {
  ...
  return (
    <motion.div
      data-mobile-card
      className="rounded-xl p-3 cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-xl border border-border/30"
      whileHover={{ scale: 1.02 }}
      onClick={() => {
        if (isGuest) {
          toast.info('Please log in or create an account to view details', {
      ...
      style={{ 
        boxShadow: `0 4px 12px ${categoryColor}08`,
        borderLeft: `3px solid ${categoryColor}`,
        background: `${categoryColor}0f`, // ~6-10% opacity
      }}
    >
      {/* Header & Category */}
...
}} className={`text-[10px] font-bold text-foreground leading-none ${isGuest ? 'blur-[4px] select-none' : ''}`}>
              {prediction?.user?.name || 'Anonymous'}
            </span>
            <span style={{
  fontSize: '12px',
  ...
  lineHeight: '1.3', 
...
}}  className="text-[9px] text-muted-foreground font-medium italic">
              Successfull Prediction : <span className="text-primary font-bold not-italic">{prediction?.user?.accuracy || '78'}%</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between text-[9px] text-muted-foreground pt-1.5 border-t border-border/30">
        <div className="flex items-center gap-1">
          <Clock size={15} style={{ color: '#000000'}} className="opacity-70" />
          <span style={{
  fontSize: '12px',
  fontWeight: 400,
  color: '#000000',
...
// /*
//   Mobile-only Roboto typography injected once via a <style> tag.
//   All selectors are scoped to [data-mobile-card] so nothing leaks to desktop.
//   max-width: 768px guard ensures zero effect on tablet/desktop.
// */
// const mobileStyles = `
...
//     /* Category label — small text tier: 11px / 400 */
//     [data-mobile-card] .mc-category-label {
//       font-size: 11px !important;
//       font-weight: 400 !important;
//       line-height: 1.3 !important;
//     }

//     /* Time remaining header — small text tier: 11px / 400 / #667781 */
//     [data-mobile-card] .mc-time-header {
//       font-size: 11px !important;
//       font-weight: 400 !important;
...
//     /* Prediction question — primary text tier: 15px / 500 */
//     [data-mobile-card] .mc-question {
//       font-size: 15px !important;
//       font-weight: 500 !important;
//       line-height: 1.35 !important;
//     }

//     /* Visibility badge — small text tier: 11px / 600 (badge needs weight) */
//     [data-mobile-card] .mc-visibility-badge {
//       font-size: 11px !important;
//       font-weight: 600 !important;
//       line-height: 1.3 !important;
//     }

//     /* Creator name — primary text tier: 15px / 500 */
//     [data-mobile-card] .mc-creator-name {
//       font-size: 15px !important;
//       font-weight: 500 !important;
//       line-height: 1.3 !important;
//     }

//     /* Success rate label — subtext tier: 12px / 400 / #667781 */
//     [data-mobile-card] .mc-success-label {
//       font-size: 12px !important;
//       font-weight: 400 !important;
//       line-height: 1.3 !important;
//     }

//     /* Success rate value — subtext tier: 12px / 500 */
//     [data-mobile-card] .mc-success-value {
//       font-size: 12px !important;
//       font-weight: 500 !important;
//       line-height: 1.3 !important;
//     }

//     /* Yes / Vague / No percentage labels — small text tier: 11px / 600 */
//     [data-mobile-card] .mc-vote-pct {
//       font-size: 11px !important;
//       font-weight: 600 !important;
//       line-height: 1.3 !important;
//     }

//     /* Footer time — subtext tier: 12px / 400 / #667781 */
//     [data-mobile-card] .mc-footer-time {
//       font-size: 12px !important;
//       font-weight: 400 !important;
//       color: #667781 !important;
//       line-height: 1.3 !important;
...
//     /* Footer vote count — body tier: 13px / 500 */
//     [data-mobile-card] .mc-vote-count {
//       font-size: 13px !important;
//       font-weight: 500 !important;
//       line-height: 1.3 !important;
//     }

//     /* "votes" suffix — small text tier: 11px / 400 */
//     [data-mobile-card] .mc-votes-suffix {
//       font-size: 11px !important;
//       font-weight: 400 !important;
//       line-height: 1.3 !important;
//     }
...
//           </div>
//           <span
//             className="mc-category-label text-[9px] font-bold uppercase tracking-wider"
//             style={{ color: categoryColor }}
//           >
//             {prediction?.field?.fields || 'General'}
//           </span>
...
//           <span className="mc-time-header text-[9px] font-medium text-muted-foreground">
//             {timeRemaining}
//           </span>
//         </div>
//       </div>
...
//       {/* Prediction Question Box */}
//       <div className="relative bg-muted/20 rounded-xl p-2 mb-0.5 border border-border/5 hover:bg-muted/30 transition-colors">
//         <div className={`mc-visibility-badge absolute top-2 right-2 flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-wider shadow-sm z-10 ${
//           prediction?.visibility === 'private'
//             ? 'bg-amber-500 text-white border-amber-600'
//             : 'bg-primary text-white border-primary-foreground/20'
//         }`}>
...
//         <p className="mc-question text-sm font-bold text-foreground line-clamp-3 leading-tight pr-12">
//           {prediction?.questions || 'No question text'}
//         </p>
//       </div>
...
//           </Avatar>
//           <div className="flex flex-col">
//             <span className={`mc-creator-name text-[10px] font-bold text-foreground leading-none ${isGuest ? 'blur-[4px] select-none' : ''}`}>
//               {prediction?.user?.name || 'Anonymous'}
//             </span>
//             <span className="mc-success-label text-[9px] text-muted-foreground font-medium italic">
//               Success Rate:{' '}
//               <span className="mc-success-value text-primary font-bold not-italic">
//                 {prediction?.user?.accuracy || '78'}%
//               </span>
//             </span>
//           </div>
//         </div>
...
//         <div className="mb-0.5">
//           <div className="flex justify-between text-[9px] font-bold uppercase tracking-widest mb-0.5">
//             <span className="mc-vote-pct text-green-500">
//               Yes {Math.round((prediction.yes_count / (prediction.answers_count || 1)) * 100)}%
//             </span>
//             <span className="mc-vote-pct text-amber-500">
//               Vague {Math.round((prediction.vague_count / (prediction.answers_count || 1)) * 100)}%
//             </span>
//             <span className="mc-vote-pct text-red-500">
//               No {Math.round((prediction.no_count / (prediction.answers_count || 1)) * 100)}%
//             </span>
//           </div>
//           <div className="h-1.5 w-full bg-muted/50 rounded-full overflow-hidden flex">
//             <div className="h-full bg-green-500 transition-all duration-500" style={{ width: `${(prediction.yes_count / (prediction.answers_count || 1)) * 100}%` }} />
...
//           <span className="mc-footer-time font-medium">{timeRemaining}</span>
//         </div>
//         <div className="flex items-center gap-0.5 bg-muted/50 px-1.5 py-0.5 rounded-full">
//           <span className="mc-vote-count font-bold text-foreground/80">
//             {prediction?.answers_count || 0}
//           </span>
//           <span className="mc-votes-suffix opacity-70">votes</span>
//         </div>
//       </div>
//     </motion.div>
//   );
