                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="relative group w-full cursor-not-allowed">
                    <button type="button" disabled
                      className="flex w-full items-center justify-center gap-2 h-10 border border-gray-200 rounded-xl bg-gray-50/50 text-xs font-semibold text-gray-400 transition-all opacity-70 pointer-events-none"
                    >
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 -top-8 bg-black/90 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-20 shadow-md">
                      Coming Soon
                    </div>
                  </div>
                  ...
                  <div className="relative group w-full cursor-not-allowed">
                    <button type="button" disabled
                      className="flex w-full items-center justify-center gap-2 h-10 border border-gray-200 rounded-xl bg-gray-50/50 text-xs font-semibold text-gray-400 transition-all opacity-70 pointer-events-none"
                    >
                      <svg className="w-4 h-4 text-[#1877F2]/70" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="col-span-2 flex justify-center mt-1">
                    <div className="relative group w-full sm:w-[calc(50%-0.25rem)] cursor-not-allowed">
                      <button type="button" disabled
                        className="flex w-full items-center justify-center gap-2 h-10 border border-gray-200 rounded-xl bg-gray-50/50 text-xs font-semibold text-gray-400 transition-all opacity-70 pointer-events-none"
                      >
