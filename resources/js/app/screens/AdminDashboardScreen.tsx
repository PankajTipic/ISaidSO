            ...
            <CardContent>
                <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold">
                        {loading && activeLoader === 'stats' ? <Loader2 className="h-6 w-6 animate-spin text-primary" /> : (value ?? 0)}
                    </div>
                    <div className={`p-2 rounded-xl border border-border/50 ${color}`}>
                        <Icon size={20} />
                    </div>
                </div>
            </CardContent>
        ...
        <div className="min-h-screen bg-background pb-24 md:pb-6">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <StatCard title="Predictions" value={stats?.predictions} icon={TrendingUp} color="bg-purple-50 text-purple-600" />
                    <StatCard title="Active Polls" value={stats?.polls} icon={PieChart} color="bg-pink-50 text-pink-600" />
                    <StatCard title="Groups" value={stats?.groups} icon={Grid} color="bg-orange-50 text-orange-600" />
                </div>
                ...
                >
                   <TabsList className="bg-muted/50 border border-border p-1 rounded-2xl w-full flex flex-wrap gap-1.5 h-auto">
  <TabsTrigger value="overview" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Overview</TabsTrigger>
  <TabsTrigger value="users" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Users</TabsTrigger>
  <TabsTrigger value="groups" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Groups</TabsTrigger>
  <TabsTrigger value="predictions" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Predictions</TabsTrigger>
  <TabsTrigger value="polls" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Polls</TabsTrigger>
  <TabsTrigger value="leaderboard" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap">Leaderboard</TabsTrigger>
  <TabsTrigger value="profile" className="flex-1 min-w-fit rounded-xl px-4 py-2.5 text-sm whitespace-nowrap flex items-center justify-center gap-1.5">
    <UserCircle size={16} />
    Profile
  </TabsTrigger>
</TabsList>
                                                ...
                                                <tbody className="divide-y divide-border">
                                                    {users?.data.map((user) => (
                                                        <tr key={user.id} className="hover:bg-muted/30 transition-colors">
                                                            ...
                                                            <td className="px-4 py-4">
                                                                <span className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider ${user.role === 'admin' ? 'bg-purple-100 text-purple-700 border border-purple-200' : 'bg-blue-100 text-blue-700 border border-blue-200'}`}>
                                                                    {user.role}
                                                                </span>
                                                            </td>
                                                            <td className="px-4 py-4">
                                                            ...
                                                            <td className="px-4 py-4 text-right">
                                                                <Button
                                                                    variant="ghost"
                                                                    size="sm"
                                                                    className={user.is_blocked ? "text-green-600 hover:text-green-700 hover:bg-green-50" : "text-red-600 hover:text-red-700 hover:bg-red-50"}
                                                        ...
                                                        groups.data.map((group) => (
                                                            ...
                                                            <td className="px-4 py-4 text-right space-x-3">
                                                                ...
                                                                <Button
                                                                    variant="ghost"
                                                                    size="sm"
                                                                    className={group.is_blocked ? "text-green-600 hover:text-green-700 hover:bg-green-50" : "text-red-600 hover:text-red-700 hover:bg-red-50"}
                    ...
                    >
                        <DialogContent className="bg-card border-border shadow-lg max-w-4xl max-h-[90vh] overflow-y-auto">
                            <DialogHeader>
                                ...
                                <div className="mt-4">
                                    {joinedGroupIds.includes(selectedGroup?.id ?? 0) ? (
                                        <Button
                                            ...
                                            onClick={() => handleLeaveGroup(selectedGroup as Group)}
                                        >
                                        ...
                                        <Button
                                            ...
                                            disabled={joiningGroupId === selectedGroup?.id}
                                            onClick={() => handleJoinGroup(selectedGroup as Group)}
                                        >
                                            {joiningGroupId === selectedGroup?.id ? (
                                                <>
                                                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                        ...
                                        <table className="w-full text-left">
                                            ...
                                            <tbody className="divide-y divide-border">
                                                {leaderboard?.data.map((entry, index) => {
                                                    ...
                                                    return (
                                                        <tr key={entry.user?.id || index} className="hover:bg-muted/30 transition-colors">
                                ...
                                {profileLoading ? (
                                    ...
                                    <div className="space-y-8">
                                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                                            ...
                                            <div className="space-y-2">
                                                <h2 className="text-2xl font-bold text-foreground">{adminProfile.name}</h2>
                        ...
                        {createType === 'prediction' ? (
                            <div className="space-y-6 mt-6">
                                ...
                                {predVisibility === 'private' && myGroups.length > 0 && (
                                    ...
                                    className={`px-4 py-2 rounded-full border text-sm transition-colors ${predSelectedGroupIds.includes(g.id)
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <RadioGroup value={pollVisibility} onValueChange={v => setPollVisibility(v as any)} className="flex gap-6">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <RadioGroupItem value="public" id="poll-private" />
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {myGroups.map(g => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-full border text-sm transition-colors ${pollSelectedGroupIds.includes(g.id)
                                                        ? 'bg-primary/10 border-primary text-primary'
                                                        : 'bg-muted/30 border-border text-muted-foreground hover:bg-muted/50'
                                                        }`}
                                                >
                ...
                >
                    <DialogContent className="bg-card border-border shadow-lg max-w-4xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                {selectedQuestion?.questions ? (selectedQuestion.questions.substring(0, 120) + (selectedQuestion.questions.length > 120 ? '...' : '')) : ''}
                            </p>
                        </DialogHeader>
                        {questionLoading ? (
                            <div className="flex justify-center py-12">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3 max-h-60 overflow-y-auto">
                                            {questionDetails.answers.map((ans: any) => (
                                                <div key={ans.id} className="p-3 rounded-lg bg-muted/30 border border-border">
